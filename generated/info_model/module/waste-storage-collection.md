...
| needs-waste-storage-area-outline | Needs waste storage area | Does the proposal require a waste storage area? | outline | MUST | Unknown is allowed in Outline applications |
...
| separate-recycling-arrangements-outline | Separate recycling arrangements (outline) | Does the proposal include separate recycling arrangements? | outline | MUST | Unknown is allowable in Outline applications |
