...
| foul-sewage-disposal-types | Foul sewage disposal types[] | List of ways foul sewage will be disposed of |  | MAY | Rule: is a MUST if `has-new-disposal-arrangements` is `True` |
...
| connect-to-drainage-system-oil-gas | Connect to drainage system (oil and gas) | Whether the proposal needs to connect to the existing drainage system (oil and gas applications) | extraction-oil-gas | MUST |  |
