...
document-types | Document types[] | Planning requirement references identifying the information this document provides. A document may address more than one requirement. These references identify its coverage; they do not establish that the requirements have been satisfied. | MUST | Select from the **planning-requirement** enum
...
field | name | description | required | notes
-- | -- | -- | -- | --
amount | Amount | The total amount due for the application fee | MAY | 
amount-paid | Amount paid | The amount paid towards the application fee | MAY | 
...
| connect-to-drainage-system-oil-gas | Connect to drainage system (oil and gas) | Whether the proposal needs to connect to the existing drainage system (oil and gas applications) | MUST | Select from the **yes-no-unknown** enum |
