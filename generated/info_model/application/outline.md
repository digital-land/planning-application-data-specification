...
* [Waste throughput unit](#waste-throughput-unit)
...
| reference | name | description | requirement | notes |
| --- | --- | --- | --- | --- |
| description | Proposal description | A description of the development, works, change of use or reserved matters for which approval is sought | MUST |  |
