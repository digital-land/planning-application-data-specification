...
| reference | name | description | requirement | notes |
| --- | --- | --- | --- | --- |
| non-residential-change-outline | Non residential change | Does the proposal involve the loss, gain, or change of non-residential floorspace? | MUST | this is only used in outline applications where unknown is an option |
...
| reserved-matters | Reserved matters[] | Identifies which reserved matters are being submitted for approval as part of this application | MUST |  |
