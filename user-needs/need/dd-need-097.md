...
status: proposed
priority: high
name: Recover the original application submission
statement: >
  As a planning authority, appellant or oversight body, I need to recover what
  was originally submitted so that procedural, appeal or enforcement questions
  can be checked against the record as it entered the planning process.
actors:
  - planning-authority
  - appellant
  - oversight-body
