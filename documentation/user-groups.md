...
| `policy-user` | People shaping, stewarding or overseeing planning policy and standards. They need evidence about how the planning system is working so they can evaluate policy, target improvements and maintain trust. | `policy-maker`, `central-government`, `mhclg`, `oversight-body`, `policy-steward`, `planning-system-steward` |
